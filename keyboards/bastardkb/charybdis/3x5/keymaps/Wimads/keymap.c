...
#define LAYOUT_Wimads(k00, k01, k02, k03, k04, k44, k43, k42, k41, k40, k10, k11, k12, k13, k14, k54, k53, k52, k51, k50, k20, k21, k22, k23, k24, k64, k63, k62, k61, k60, k32, k33, k30, k70, k73, k72) \
    { {k00, k01, k02, k03, k04}, {k10, k11, k12, k13, k14}, {k20, k21, k22, k23, k24}, {k30, KC_NO, k32, k33, KC_NO}, {k40, k41, k42, k43, k44}, {k50, k51, k52, k53, k54}, {k60, k61, k62, k63, k64}, {k70, KC_NO, k72, k73, KC_NO}, }
...
customshift_keycode_t keymap[KEY_MAP_SIZE] = {
    ...
    {KC_7, KC_F7},
    {KC_8, KC_F8},
    {KC_9, KC_F9}, // F12  F7  F8  F9
    {KC_PLUS, KC_F11},
    {KC_4, KC_F4},
    {KC_5, KC_F5},
    {KC_6, KC_F6}, // F11  F4  F5  F6
    {KC_ASTR, KC_F10},
    {KC_1, KC_F1},
    {KC_2, KC_F2},
