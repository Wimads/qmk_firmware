...
#define HLCC_TIMEOUT 20
#define HLCCKEY KC_NUM              // set which lock key acts as HLCC channel
...
bool led_update_user(led_t led_state) {
    ...
    // hlcc LED status:
    const bool     hlcc_led_state     = led_state.num_lock;                     // set which LED to use for HLCC channel
